...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($fileError === 0) {
        ...
        if (move_uploaded_file($fileTmpName, $uploadDir . $newFileName)) {
            ...
            $sql = "INSERT INTO rencana_kegiatan_anggaran (id_admin, nama_dokumen, tahun_anggaran, keterangan, pengumpulan_dokumen) 
                    VALUES (1, '$nama_dokumen', '$tahun_anggaran', '$keterangan', '$newFileName')";
        ...
        $sql = "INSERT INTO rencana_kegiatan_anggaran (id_admin, nama_dokumen, tahun_anggaran, keterangan) 
                VALUES (1, '$nama_dokumen', '$tahun_anggaran', '$keterangan')";
